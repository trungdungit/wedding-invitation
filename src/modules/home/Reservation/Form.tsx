    ...
    return (
        <form onSubmit={submit} className="space-y-3 mt-10 max-w-xl mx-auto px-5 md:px-0">
            ...
            <div>
                ...
                <FieldError name="Lời nhắn" />
            </div>
            <div className="space-y-4 md:space-y-2 pt-2">
                <p className="font-roboto-slab text-sm md:text-base font-medium">Xác nhận tham dự</p>
                <div className="flex items-center gap-3">
                    <input
                        ...
                        value="1"
                    />
                    <label htmlFor="yes" className="font-roboto-slab text-sm md:text-base">Có, tôi sẽ tham dự</label>
                </div>
                <div className="flex items-center gap-3">
                    <input
                        id="no"
                        ...
                        defaultChecked
                    />
                    <label htmlFor="no" className="font-roboto-slab text-sm md:text-base"> Rất tiếc, tôi không tham dự được</label>
                </div>
            </div>
