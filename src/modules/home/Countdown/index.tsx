...
export default function Countdown() {
    ...
    const countdown = () => {
        const weddingDay = new Date("Apr 13, 2025 11:00:00").getTime()
    ...
    return (
        <section className="container-box2 mt-betweenSectionMd xl:mt-betweenSection py-14 xl:py-20">
            <motion.div
                ...
                {...anim(stagger)}
            >
                <Li type="Ngày" value={time.days} delay={0.2} />
                <Li type="Giờ" value={time.hour} delay={0.4} />
                <Li type="Phút" value={time.minute} delay={0.6} />
                <Li type="Giây" value={time.second} delay={0.8} />
            </motion.div>
        </section>
